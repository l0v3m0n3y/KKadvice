...
class KKadvice {
private:
    std::string api_base = "https://kk-advice.koyeb.app/api";
...
public:
    ...
    pplx::task<json::value> get_random_advice() {
        return make_api_call("/advice", "GET");
    }

    pplx::task<json::value> get_all_advice() {
        return make_api_call("/advice/all", "GET");
    }

    pplx::task<json::value> get_advice_by_id(int advice_id) {
        return make_api_call("/advice/" + std::to_string(advice_id), "GET");
    }
};
